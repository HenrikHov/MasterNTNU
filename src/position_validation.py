...
def main():
    ...
    rospy.loginfo(f"T-matrix from gripper a to b: {T_final}")

if __name__ == "__main__":
    rospy.init_node("position_validator")
    main()
